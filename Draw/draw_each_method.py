...
fname_la = './each_method/OptimalActionProbability_Ave_LA_theta1.0.npy'   #change when you need
...
# 横軸のメモリを5刻みに設定
plt.xticks(np.arange(0, episode_num + 1, 5))

plt.savefig('compare_each_method_jpn_ms_ep20.png')   #!change
plt.show()
